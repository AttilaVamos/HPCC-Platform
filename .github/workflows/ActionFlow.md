...
Test_Build::build-workflow-dispatch --> Build Package (Docker) ;
test-workflow-dispatch[test-workflow-dispatch]
build-workflow-dispatch -->Test_Build::test-workflow-dispatch --> Smoketest Package (gh-runner) ;
build-docker-ubuntu-23_10[build-docker-ubuntu-23_10]
Test_Build::build-docker-ubuntu-23_10 --> Build Package (Docker) ;
build-docker-ubuntu-22_04[build-docker-ubuntu-22_04]
Test_Build::build-docker-ubuntu-22_04 --> Build Package (Docker) ;
test-smoke-docker-ubuntu-22_04[test-smoke-docker-ubuntu-22_04]
build-docker-ubuntu-22_04 -->Test_Build::test-smoke-docker-ubuntu-22_04 --> Smoketest Package (gh-runner) ;
test-regression-suite-k8s-ubuntu-22_04[test-regression-suite-k8s-ubuntu-22_04]
Test_Build::test-regression-suite-k8s-ubuntu-22_04 --> Regression Suite on K8s ;
test-unit-docker-ubuntu-22_04[test-unit-docker-ubuntu-22_04]
build-docker-ubuntu-22_04 -->Test_Build::test-unit-docker-ubuntu-22_04 --> Unittest Package (gh-runner) ;
test-ui-docker-ubuntu-22_04[test-ui-docker-ubuntu-22_04]
build-docker-ubuntu-22_04 -->Test_Build::test-ui-docker-ubuntu-22_04 --> UI test Package (gh-runner) ;
build-docker-ubuntu-20_04[build-docker-ubuntu-20_04]
Test_Build::build-docker-ubuntu-20_04 --> Build Package (Docker) ;
build-docker-centos-8[build-docker-centos-8]
Test_Build::build-docker-centos-8 --> Build Package (Docker) ;
build-docker-centos-7[build-docker-centos-7]
Test_Build::build-docker-centos-7 --> Build Package (Docker) ;
build-docker-amazonlinux[build-docker-amazonlinux]
Test_Build::build-docker-amazonlinux --> Build Package (Docker) ;
build-gh_runner-ubuntu-22_04[build-gh_runner-ubuntu-22_04]
Test_Build::build-gh_runner-ubuntu-22_04 --> Build Package (gh-runner) ;
build-gh_runner-ubuntu-20_04[build-gh_runner-ubuntu-20_04]
Test_Build::build-gh_runner-ubuntu-20_04 --> Build Package (gh-runner) ;
build-gh_runner-windows-2022[build-gh_runner-windows-2022]
Test_Build::build-gh_runner-windows-2022 --> Build Package (gh-runner) ;
build-gh_runner-windows-2019[build-gh_runner-windows-2019]
Test_Build::build-gh_runner-windows-2019 --> Build Package (gh-runner) ;
build-gh_runner-macos-12[build-gh_runner-macos-12]
Test_Build::build-gh_runner-macos-12 --> Build Package (gh-runner) ;
build-gh_runner-macos-11[build-gh_runner-macos-11]
Test_Build::build-gh_runner-macos-11 --> Build Package (gh-runner) ;
...
build-docker[build-docker]
Regression_Suite_on_K8s::build-docker --> Build Package (Docker) ;
main[main]
