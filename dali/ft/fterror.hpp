...
#define DFTERR_RecordSizeNotMatch               8114
...
#define DFTERR_RecordSizeNotMatch_Text          "Provided record size (%d) does not match to the calculated from the record structure (%d)"
